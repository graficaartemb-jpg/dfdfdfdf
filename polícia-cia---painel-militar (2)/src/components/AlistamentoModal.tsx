      ...
      >
        ...
        <div className="p-4 border-b border-zinc-900 bg-zinc-900/30 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-tactical font-semibold text-zinc-100 tracking-wider font-sans">
              ALISTAMENTO / EXAME DE RECRUTAS
            </h3>
          </div>
          <button
            onClick={onClose}
            className="text-zinc-500 hover:text-zinc-200 transition-colors cursor-pointer text-sm font-sans"
          >
            Fechar ✕
          </button>
        </div>
        ...
        <div className="p-6">
          {passo === 0 && (
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-zinc-500 font-tactical text-xs tracking-wider mb-2 font-mono">
                ...
                <input
                  ...
                  className="w-full bg-zinc-900/40 border border-zinc-800 focus:border-red-600 text-zinc-100 font-tactical px-4 py-3 rounded-md outline-none transition-all placeholder:text-zinc-700 font-sans"
                />
              </div>
              <button
                disabled={!nickRecruta.trim()}
                onClick={() => setPasso(1)}
                className="w-full bg-gradient-to-r from-red-950 via-red-800 to-red-950 text-white font-tactical font-semibold tracking-wider py-3 rounded-md hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50 disabled:pointer-events-none cursor-pointer text-sm font-sans"
              >
          ...
          {passo >= 1 && passo <= 4 && (
            <div className="space-y-6">
              ...
              <h4 className="text-lg font-tactical font-medium text-zinc-100 leading-snug font-sans">
