...
import {
  ...
  obterApostilas, salvarApostila, excluirApostila, limparEResetarBancoDeDados
} from '../lib/db';
...
export default function Dashboard({ policialInicial, onLogout }: DashboardProps) {
  ...
  const obterPermissoesUsuario = (): CargoPermissao => {
    ...
    // Non-admin accounts have limited access and cannot promote, demote, or manage hierarchy/groups
    return {
      abasAcessiveis: ['inicio', 'perfil', 'avisos', 'aulas'],
      podePromoverRebaixar: false,
      podePostarAvisos: false,
      podeEnviarXP: false,
      podeCriarTreinamentos: false,
      podeAvaliarAulas: false,
      podeGerenciarGrupos: false,
              ...
              >
                ...
                <div className="bg-zinc-950/60 border border-emerald-900/40 rounded-lg p-5 flex flex-col md:flex-row justify-between items-stretch md:items-center gap-4 relative overflow-hidden">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-zinc-400 font-tactical leading-relaxed">
                      Gerencie e aprove solicitações de alistamento pendentes de novos usuários para integrá-los como Recrutas da Polícia CIA.
                    </p>
                  </div>
                </div>
                        ...
                        <div className="bg-red-950/15 border border-red-900/50 p-4 rounded-lg space-y-3">
                          <div>
                            ...
                            <p className="text-[10px] text-zinc-400 leading-normal mt-1">
                              Esta ação apagará permanentemente todos os policiais, avisos, grupos, advertências, logs e dados no site local e no banco de dados Supabase conectado. NENHUM dado será preservado, exceto a conta administradora suprema <strong className="text-zinc-200">admin</strong> (senha: <strong className="text-zinc-200">admin#geral</strong>) para garantir que você possa redefinir as credenciais.
                            </p>
                          </div>
