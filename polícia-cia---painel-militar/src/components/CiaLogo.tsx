...
interface CiaLogoProps {
  config?: ConfiguracaoSite | null;
}

export default function CiaLogo({ config: propConfig }: CiaLogoProps = {}) {
  ...
  return (
    <div className="flex flex-col items-center select-none">
      ...
      >
        <span className="text-[52px] sm:text-[64px] font-anton tracking-wide text-metallic leading-none uppercase font-sans font-black">
          {part1}
        </span>
        {part2 && (
          <span className="text-[52px] sm:text-[64px] font-anton tracking-wide text-red-600 text-red-glow leading-none uppercase font-sans font-black">
            {part2}
          </span>
        )}
      </motion.div>
