          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[9px] sm:text-[10px] text-zinc-500 font-tactical tracking-wider uppercase">
                {config?.nomeSite || 'POLÍCIA CIA'} • DEPARTAMENTO DE DOUTRINA & COMUNICAÇÃO
              </p>
            </div>
          </div>
                          ...
                          return (
                            ...
                            >
                              ...
                              <button
                                ...
                                className="w-full px-4 py-3.5 flex items-center justify-between hover:bg-zinc-900/30 transition-all text-left cursor-pointer select-none gap-3"
                                id={`trigger_parte_${parte.id}`}
                              >
                                <div className="flex items-center gap-2.5 min-w-0">
                                  <span className="w-5 h-5 rounded bg-zinc-900 border border-zinc-800 text-amber-500 font-mono text-[10px] flex items-center justify-center font-bold shrink-0">
                                    {index + 1}
                                  </span>
                                  <div className="min-w-0">
                                    <span className="font-tactical font-bold text-xs text-zinc-200 hover:text-amber-400 transition-colors block truncate">
                                      {parte.tituloParte}
                                    </span>
                                    {parte.subtituloParte && (
                                      <span className="text-[11px] text-zinc-400 font-sans font-normal block truncate mt-0.5">
                                        {parte.subtituloParte}
                                      </span>
                                    )}
                                  </div>
